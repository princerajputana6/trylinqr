...
export const HERO_POSTERS = [
  ...
  {
    slug: 'food',
    eyebrow: 'TryLinqr Vol. 24 · Late Plate',
    photo:
      'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=1600&q=80',
    accent: '#9a795d',
    accentSoft: '#fbbf24',
    headline: [
      { text: 'CHEF', color: '#ffffff' },
      { text: 'TABLE', color: '#fbbf24' },
      { text: 'POP-UPS', color: '#fff7e9' },
    ],
    tagline: 'Supper clubs · Brewery nights · Food trails',
    badges: [
      { label: 'Seats', value: 'Limited', tone: 'dark' },
      { label: 'Menu', value: 'Tasting', tone: 'sand' },
    ],
    cta: 'Reserve a seat',
    href: '/categories/food',
    stamp: 'TABLE · SERIAL 24-FD-067',
    dark: true,
  },
];
